...
module blk_mem_gen_0(clka, addra, douta, clkb, enb, addrb, doutb)
/* synthesis syn_black_box black_box_pad_pin="clka,addra[17:0],douta[0:0],clkb,enb,addrb[17:0],doutb[0:0]" */;
  input clka;
  input [17:0]addra;
  output [0:0]douta;
  input clkb;
